...
// 5. Toasts Component
function Toasts({ position = "bottom-right" }: ToastsProps): React.JSX.Element {
              ...
              <Toast.Content className="pointer-events-auto flex items-center justify-between gap-1.5 overflow-hidden px-3.5 py-3 text-sm transition-opacity duration-250 data-behind:pointer-events-none data-behind:opacity-0 data-expanded:opacity-100">
                <div className="flex gap-2">
                  {Icon && (
                    ...
                    >
                      <Icon className="in-data-[type=loading]:animate-spin in-data-[type=error]:text-destructive in-data-[type=info]:text-info in-data-[type=success]:text-green-500 in-data-[type=warning]:text-warning in-data-[type=loading]:opacity-72" />
                    </div>
                  )}
...
// 6. AnchoredToastProvider Component
...
// 7. AnchoredToasts Component
function AnchoredToasts(): React.JSX.Element {
  const { toasts } = Toast.useToastManager();

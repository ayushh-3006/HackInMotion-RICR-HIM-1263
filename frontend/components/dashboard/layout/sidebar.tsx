  ...
  return (
    <aside className="w-64 flex-shrink-0 border-r border-slate-200 bg-white h-screen flex flex-col transition-all duration-300 hidden md:flex sticky top-0">
      ...
      <div className="p-4 border-t border-slate-100">
        <div className="flex items-center justify-between p-3 rounded-2xl bg-slate-50 border border-slate-100 hover:shadow-sm hover:border-slate-200 transition-all cursor-pointer">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-indigo-100 flex items-center justify-center overflow-hidden border border-indigo-200">
              <img 
                src="https://api.dicebear.com/7.x/avataaars/svg?seed=Anit" 
                alt="User Avatar" 
                className="w-full h-full object-cover"
              />
            </div>
            <div className="flex flex-col">
              <span className="text-sm font-bold text-slate-900 leading-tight">Anit Kushwaha</span>
              <span className="text-xs text-slate-500 font-medium">Free Plan</span>
            </div>
          </div>
          <ChevronUp className="w-4 h-4 text-slate-400" />
        </div>
        <button className="w-full mt-3 py-2.5 px-4 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-xl shadow-sm shadow-indigo-200 transition-colors flex items-center justify-center">
          Upgrade
        </button>
      </div>
    </aside>

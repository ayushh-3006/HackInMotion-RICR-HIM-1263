          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 lg:px-10 flex flex-col md:flex-row items-center md:items-start justify-between gap-10 lg:gap-20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12 flex-1 w-full justify-end text-left pt-1">
              ...
              <div className="flex flex-col gap-3">
                <h3 className="text-gray-900 font-manrope font-semibold text-base">
                  Platform
                </h3>
            ...
            <div className="overflow-y-auto py-4 text-xs leading-relaxed text-gray-600 flex flex-col gap-3 pr-1">
              {modalType === "privacy" ? (
                <>
                  ...
                  <p>
                    At <strong>Resumind</strong>, we respect your privacy and
                  ...
                  <p>
                    We collect profile details provided during account creation
                    and resume files uploaded for AI processing, enhancement,
                    and ATS compatibility checks.
                  </p>
                  <h4 className="font-semibold text-gray-900 pt-1">
                    2. How We Use Data
                  </h4>
                  <p>
                    Your data is strictly used to render ATS scores, generate
                    tailored bullet points, and store draft resumes securely in
                    your dashboard. We do not sell user data to third parties.
                  </p>
                  <h4 className="font-semibold text-gray-900 pt-1">
                    3. Security
                  </h4>
                  <p>
                    All communication with our servers is encrypted using
                    industry-standard TLS. Your records are isolated and
                    protected.
                  </p>
                  <h4 className="font-semibold text-gray-900 pt-1">
                    4. Contact
                ...
                <>
                  ...
                  <p>
                    Welcome to <strong>Resumind</strong>. By using our platform,
                  ...
                  <p>
                    Resumind provides AI-assisted resume building and ATS
                    scoring tools. You agree to use the service in compliance
                  ...
                  <p>
                    AI-generated text and ATS recommendations are provided for
                    guidance. Users are responsible for verifying accuracy
                    before submitting resumes to prospective employers.
                  </p>
                  <h4 className="font-semibold text-gray-900 pt-1">
                    4. Termination
                  </h4>
                  <p>
                    ...
                    accounts that violate these terms or abuse platform
                    resources.
                  </p>
                </>
              )}

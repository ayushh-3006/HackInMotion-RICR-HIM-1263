...
export function FAQs() {
  return (
    <section
      id="faqs"
      className="mx-auto w-full max-w-7xl overflow-hidden px-6 md:px-12 py-20 sm:py-24 scroll-mt-28"
    >
      ...
      <div className="flex flex-col md:flex-row items-start justify-between gap-12 w-full">
        <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-4 md:w-1/3 w-full">
          ...
          <p className="text-gray-600 font-inter text-sm sm:text-base max-w-2xl">
            Clear answers about how it works, what to expect, and how you can
            get the most out of it.
          </p>
        </div>

        <Accordion
          className="w-full md:w-3/5 space-y-3"
          collapsible
          type="single"
        >
          {questions.map((item) => (
